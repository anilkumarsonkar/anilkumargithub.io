...
$ctmid=$_REQUEST['id'];
include("../connect.php");
$query="select * from tbl_complaint_type_mng where ctmid='$ctmid'";
...
<hr/>
               ...
               <a href="../userdashboard.php" style="text-decoration:none; color:black;"><h6>USER lOG MANAGEMENT  </h6></a><hr/>
                ...
                <div class="container m-0 p-0 mt-2 n2">
                    <nav class="navbar navbar-expand-lg bg-body-tertiary">
                        <div class="container-fluid">
                            <a class="navbar-brand" href="#">UpdateCollege</a>
                        </div>
                    </nav>
                </div>
<form action="updatectm.php" method="post">
          <!-- <h5>College<h5> -->
          <input type="hidden" name="cd" value="<?php echo $row['ctmid']; ?>"/>
          <br/>
          <input type="text" name="clg" value="<?php echo $row['ctmname']; ?>"/>
          <br/>
          <br/>
