<?php
include("../connect.php");
$query="select * from register where status='Y'";
...
<head>
    ...
    .t{
        height:80px; width:250px; background-color:red; margin-left:420px; border-radius:20px;
        color:white;
        margin-top:80px;
    }
    .t:hover{
...
<hr/>
            ...
            <div class="col-sm-10 m-0 p-0">
               ...
               <div class="t"style="">
               <h4 style="padding-top:25px; text-align:center;">Blocked User</h4></div>
...
<tr>
    ...
    <td><a href="unblockcode.php?id=<?php echo $row['id'];?>"><?php echo $row['status']; ?></a></td>
