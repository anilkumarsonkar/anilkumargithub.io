...
while($row=mysqli_fetch_array($res)){
    ...
    <tr>
        ...
        <td><a href="view.php?qid=<?php echo $row['qid']?>" style="text-decoration:none;"</style><i class="fa-solid fa-square-arrow-up-right text-light"></i>View</a></td>
</tr>
    <?php
    $a++;
}
