          ...
          <div class="row m-0 p-0">
            <div class="col-sm-6">
              <div class="card-body">
                ...
                <form action="uchangecode.php" method="post">
                  <center>
                  ...
                  <div class="form-outline mb-2">
                    <input type="password" class="form-control"
                      placeholder="Old Password" name="opp" style=" width:400px; margin-left:50px;" />
                    <label class="form-label" for="form2Example11">Old Password</label>
                  </div>
                  <div class="form-outline mb-2 ">
                    <input type="password"  class="form-control" name="npp" style=" width:400px; margin-left:50px;" placeholder="New Password"/>
                    <label class="form-label" for="form2Example22">New Password</label>
                  </div>

                  <div class="form-outline mb-2">
                    <input type="password"  class="form-control" name="cpp" style=" width:400px; margin-left:50px;" placeholder="Confirm Password" />
                    <label class="form-label" for="form2Example22">Confirm Password</label>
                  </div>

                  <div class="text-center pt-1 mb-5 pb-1">
                    <button class="btn btn-primary  fa-lg" type="submit" style="height:40px; width:300px; margin-right:200px;  margin-left:200px;">Change
                     </button>
