...
<body>
 ...
 <a href="dashboard.php" style="text-decoration:none;"> <h5 align="" style="color:black; "> <i class="fa-solid fa-gauge-high"></i>&nbsp;&nbsp;
  ...
  <ul class="dropdown-menu">
    ...
    <li><a class="dropdown-item" href="dr.php">Download Report</a></li>
                ...
                <div class="container m-0 p-0 mt-2 n2">
                    <nav class="navbar navbar-expand-lg bg-body-tertiary">
                        <div class="container-fluid">
                            <a class="navbar-brand" href="#">Close Complain</a>
                        </div>
                    </nav>
                </div>
                <!-- second navbar end -->
...
<table>
    ...
    <td><?php $name= $row['id'];?>   
    <?php $query3="select * from register  where id ='$name'";
    ...
    ?>  <td><?php echo $row['complain'];?></td>
        <td><button class="npy">✔<a href="cstatus.php?id=<?php echo $row['cmpid'];?>"><?php echo $row['status'];?>losed</a></button></td>
        
        <td><?php echo $row['doc'];?></td>
        <td><?php echo $row['docompletion'];?></td>
